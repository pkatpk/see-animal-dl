...
def main(cfg):
    ...
    tr_dl, val_dl, classes = get_dataloaders(cfg.data_dir, cfg.img, cfg.batch, cfg.seed)
...
if __name__ == "__main__":
    ...
    pa.add_argument("--model", required=True, help="class name in src.models, e.g. CNN01")
    pa.add_argument("--model-kw", default="", help='extra kwargs JSON, e.g. \'{"drop":0.3}\'')
    ...
    pa.add_argument("--patience", type=int, default=3, help="early stopping patience")
    main(pa.parse_args())
